...
* The **explorer** series is more casual with a focus on exploration and lore
* The **independent** series is just a name for other games I create that do not fit either of the other series
...
* Release a new beta during the **Spring Sale**
* A full release during the **Summer Sale**
* Release a new beta during the **Autumn Sale**
* A full release during the **Winter Sale**

## Betas
Betas (or *early access*) are versions of a product containing only the essentials rather than a complete package.

They are meant to:
* Involve the audience midway through the creation process rather than only when it is over and too late for major changes
* Help the audience finance the project, paying less for an unfinished product but then receiving the completed game later
...
* I have built all my games on my own, none of them using third-party engines like Godot; Unity or Unreal
* I have used code-generation for small classes (such as for formatting time) or scripts (such as one-use file-converters)
* I may find other uses as technology evolves but generally do not find it a good substitute for writing my own code-base
...
# Links
* Minim, my minimalistic rules-system, <https://github.com/tukkek/minim>
* Easy Ido, <https://en.wikibooks.org/wiki/Easy_Ido>
